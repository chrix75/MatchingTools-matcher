...
class CompanyMatcherTest extends GroovyTestCase {
    ...
    void testMatch_1() {
        def record1 = new Record([ims], [aguesseau128], "", boulogne)
        def record2 = new Record([ims], [aguesseau128], "", boulogne)

        assertEquals(Match.MATCH, matcher.match(record1, record2))
    }

    void testMatch_2() {
        def record1 = new Record([ims], [aguesseau122], "", boulogne)
        def record2 = new Record([ims], [aguesseau128], "", boulogne)
    ...
    void testMatch_3() {
        def record1 = new Record([ims], [aguesseau137], "", boulogne)
        def record2 = new Record([ims], [aguesseau128], "", boulogne)
    ...
    void testMatch_4() {
        def record1 = new Record([ims], [aguesseau128], "", boulogne)
        def record2 = new Record([cegedim], [aguesseau128], "", boulogne)
    ...
    void testMatch_5() {
        def record1 = new Record([ims], [aguesseau128], "", boulogne)
        def record2 = new Record([ims], [aguesseau128, reine], "", boulogne)
    ...
    void testMatch_6() {
        def record1 = new Record([ims], [aguesseau128], "", boulogne)
        def record2 = new Record([ims], [reine], "", boulogne)
    ...
    void testMatch_7() {
        def record1 = new Record([ims], [aguesseau128], "", boulogne)
        def record2 = new Record([ims], [aguesseau128], "", paris)

        assertEquals(Match.UNMATCH, matcher.match(record1, record2))
    }

    void testMatch_8() {
        def record1 = new Record([ims], [aguesseau128], siret1, boulogne)
        def record2 = new Record([ims], [aguesseau128], siret2, boulogne)

        assertEquals(Match.UNMATCH, matcher.match(record1, record2))
    }

    void testMatch_9() {
        def record1 = new Record([ims], [reine], siret1, boulogne)
        def record2 = new Record([ims], [aguesseau128], siret1, boulogne)
    ...
    void testMatch_10() {
        def record1 = new Record([ims], [aguesseau128], "", boulogne)
        def record2 = new Record([imsCommunicationDirect], [aguesseau128], "", boulogne)
